# Code below not written by us, just modified to fit our project needs
# Credit: Gil Vargas
# GitHub: https://github.com/guser210/Pico/blob/main/MicorPython/NRFDemo.py
import utime
...
class NRF:
    ...
    def config(self):
        ...
        self.writeReg(0x0A, bytearray("gyroc", 'utf-8'))
        self.writeReg(0x10, bytearray("gyroc", 'utf-8'))
